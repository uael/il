#ifndef _JAYL_LIST_H_
#define _JAYL_LIST_H_
...
/** Defines an initialized (static) list reference */
#define LIST_HEAD_REF(name) \
 ...
 */
static inline void list_add(list_t *new_node, list_t *head) {
 ...
 */
static inline void list_add_tail(list_t *new_node, list_t *head) {
