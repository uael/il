#ifndef _JAYL_ENVIRONMENT_H
#define _JAYL_ENVIRONMENT_H
...
/// IR is lowered tensors are replaced by arrays.)
    class Environment {
      ...
      /// Get global externs. Externs must be bound before a jayl::Function is run.
      ...
      /// lowering passes, and must be initialized before a jayl::Function is run.
