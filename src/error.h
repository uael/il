#ifndef _JAYL_DIAGNOSTICS_H
#define _JAYL_DIAGNOSTICS_H
...
namespace jayl {
  ...
  class JaylException : public std::exception {
    public:
    JaylException() {
      errStringStream << " IR stack:" << std::endl;
    }

    JaylException(JaylException &&other) {
...
/// Provides information about errors that occur while loading Jayl code.
  class ParseError {
    public:
...
#ifdef JAYL_ASSERTS
#define iassert(c)                                                           \
    jayl::internal::ErrorReport(__FILE__, __FUNCTION__, __LINE__, (c), #c,    \
                               jayl::internal::ErrorReport::Internal, false)
#define ierror                                                               \
    jayl::internal::ErrorReport(__FILE__, __FUNCTION__, __LINE__, false, NULL,\
                               jayl::internal::ErrorReport::Internal, false)
#else
    struct Dummy {
      template<typename T>
...
#define iassert(c) jayl::internal::Dummy()
#define ierror jayl::internal::Dummy()
#endif
...
#define uassert(c)                                                             \
  jayl::internal::ErrorReport(__FILE__,__FUNCTION__,__LINE__, (c), #c,        \
                               jayl::internal::ErrorReport::User, false)
#define uerror                                                                 \
  jayl::internal::ErrorReport(__FILE__,__FUNCTION__,__LINE__, false, nullptr, \
                               jayl::internal::ErrorReport::User, false)
#define uwarning                                                               \
  jayl::internal::ErrorReport(__FILE__,__FUNCTION__,__LINE__, false, nullptr, \
                               jayl::internal::ErrorReport::User, true)

// Temporary assertions (planned for the future)
#define tassert(c)                                                             \
  jayl::internal::ErrorReport(__FILE__, __FUNCTION__, __LINE__, (c), #c,      \
                               jayl::internal::ErrorReport::Temporary, false)
#define terror                                                                 \
  jayl::internal::ErrorReport(__FILE__, __FUNCTION__, __LINE__, false, NULL,  \
                               jayl::internal::ErrorReport::Temporary, false)
