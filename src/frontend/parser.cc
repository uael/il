...
// Jayl language grammar is documented here in EBNF. Note that '{}' is used
...
//                | func_decl | test
    fir::FIRNode::Ptr Parser::parseProgramElement() {
      try {
        ...
        skipTo({
          Token::Type::TEST, Token::Type::FUNC, Token::Type::EXPORT,
...
// do_while_stmt: 'do' stmt_block 'end' 'while' expr
    fir::DoWhileStmt::Ptr Parser::parseDoWhileStmt() {
      try {
        ...
        skipTo({
          Token::Type::BLOCKEND, Token::Type::ELIF, Token::Type::ELSE,
