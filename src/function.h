#ifndef _JAYL_FUNCTION_H
#define _JAYL_FUNCTION_H
...
/// A callable Jayl function. You can bind arguments and externs (bindables) to
...
/// automatically.
  class Function {
    ...
    void bind(const std::string &name, jayl::Set *set);
