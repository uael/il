#ifndef _JAYL_GRAPH_H
#define _JAYL_GRAPH_H
...
/// A Jayl element reference.  All Jayl elements live in Jayl sets and an
...
/// can be passed as bound inputs to Jayl programs.
  class Set {
    public:
    enum Kind {
      Unstructured, Grid
    ...
    inline
    std::vector<FieldData *> &getFields() { return fields; }
