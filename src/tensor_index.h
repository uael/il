#ifndef _JAYL_TENSOR_INDEX_H
#define _JAYL_TENSOR_INDEX_H
...
/// function of a Jayl graph.  Such tensor indices are added to the
...
/// from an extern function, or by Jayl as they are computed.
/// Note: only sparse matrix CSR indices are supported for now.
    class TensorIndex : public interfaces::Comparable<TensorIndex> {
      ...
      /// function, or by Jayl as they are computed.
