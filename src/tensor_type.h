#ifndef _JAYL_TENSOR_TYPE_H
#define _JAYL_TENSOR_TYPE_H
...
/** The types of supported tensor components. */
  enum class ComponentType {
    Float, Double, Int, Boolean, FloatComplex, DoubleComplex
  };

/** Helper to convert from C++ type to Jayl Type. */
  template<typename T>
  inline ComponentType typeOf() {
    ierror << "Unsupported type";
    return ComponentType::Int; // TODO XXX gcc warning suppression
  }

  template<>
  inline ComponentType typeOf<int>() {
    return ComponentType::Int;
  }

  template<>
  inline ComponentType typeOf<float>() {
    return ComponentType::Float;
  }

  template<>
  inline ComponentType typeOf<double>() {
    return ComponentType::Double;
  }

  template<>
  inline ComponentType typeOf<bool>() {
    return ComponentType::Boolean;
  }

  template<>
  inline ComponentType typeOf<float_complex>() {
    return ComponentType::FloatComplex;
  }

  template<>
  inline ComponentType typeOf<double_complex>() {
...
/// type descriptor.
  ...
  template<>
  inline TensorType computeType<float>() {
    return jayl::ComponentType::Float;
  }

  template<>
  inline TensorType computeType<double>() {
    return jayl::ComponentType::Double;
  }

  template<>
  inline TensorType computeType<int>() {
    return jayl::ComponentType::Int;
  }

  template<>
  inline TensorType computeType<bool>() {
    return jayl::ComponentType::Boolean;
  }
