#ifndef _JAYL_TYPES_H
#define _JAYL_TYPES_H
...
namespace jayl {
  namespace ir {
    ...
    class Type {
      public:
      enum Kind {
        Undefined, Tensor, Element, Set, UnnamedTuple, NamedTuple, Array, Opaque
      };
    ...
    struct ScalarType {
      enum Kind {
        Float, Int, Boolean, Complex, String
      };
...
/** Helper to convert from C++ type to Jayl Type. */
    template<typename T>
    inline ScalarType typeOf() {
      ierror << "Unsupported type";
      return ScalarType::Int; // Suppress warning
    }

    template<>
    inline ScalarType typeOf<int>() {
      return ScalarType::Int;
    }

    template<>
    inline ScalarType typeOf<float>() {
      return ScalarType::Float;
    }

    template<>
    inline ScalarType typeOf<double>() {
      return ScalarType::Float;
    }

    template<>
    inline ScalarType typeOf<bool>() {
      return ScalarType::Boolean;
    }

    template<>
    inline ScalarType typeOf<float_complex>() {
      return ScalarType::Complex;
    }

    template<>
    inline ScalarType typeOf<double_complex>() {
      return ScalarType::Complex;
    }
...
//       permitted.
    struct TensorType : TypeNode {
      ...
      /// not used by the Jayl compiler, but is here to ease frontend development.
      bool isColumnVector;
...
/// The type of a Jayl set.  If the set is an edge set then the vector
