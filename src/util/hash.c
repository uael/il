 ...
 */
static unsigned long djb2_hash(string_t str) {
  int c;
...
static struct hash_entry *hash_alloc_entry(hash_map_t *tab) {
...
static void hash_free_entry(hash_map_t *tab, struct hash_entry *ref) {
